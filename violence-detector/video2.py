...
os.environ['TF_CPP_MIN_LOG_LEVEL'] = '3'  # Hide INFO and WARNING messages from TensorFlow
warnings.filterwarnings("ignore", category=UserWarning)  # Suppress keras & other user warnings
...
if __name__ == "__main__":
    ...
    try:
        ...
        # Logging (print normally for console visibility)
        print("\n==== Video Processing Complete ====")
        print(f"Highest Accuracy: {highest_pred}")
        print(f"Average Accuracy: {avg_pred}")

        # Output ONLY JSON to be parsed correctly
